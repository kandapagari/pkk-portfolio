...
const About = () => {
    return (
        <div className="w-full md:h-screen p-2 flex items-center py-16">
            <div className="max-w-[12400px] mx-auto md:grid grid-cols-3 gap-8">
                ...
                <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
                    {/* <Image src="/../public/assets/about-photo.jpg" alt="/" width='5616px' height='3744px' /> */}
                    <Image className="rounded-xl" src="/../public/assets/alt-about.jpg" alt="/" width='1960px' height='2959px' />
                </div>
            </div>
        </div>
    );
